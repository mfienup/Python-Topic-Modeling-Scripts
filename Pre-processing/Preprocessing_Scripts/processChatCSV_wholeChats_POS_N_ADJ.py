""" File:  processChatCSV_wholeChats_POS_N_ADJ.py
    Description:  Takes as input raw chat data .csv file and each chat is analyzed
    to keep only Parts-of-Speech (POS) of nouns and adjectives.
...
WHOLE_CHATS_OUTPUT_FILE_NAME = "wholeChatsFilePOS_N_ADJ.csv"
WHOLE_CHATS_OUTPUT_FILE_NAME_TXT = "wholeChatsFilePOS_N_ADJ.txt"
