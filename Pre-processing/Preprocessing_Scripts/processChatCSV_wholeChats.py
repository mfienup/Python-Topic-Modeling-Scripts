""" File:  processChatCSV_wholeChats.py
    Description:  Takes as input raw chat data .csv file and each chat is analyzed to "clean" the text by: 
...
WHOLE_CHATS_OUTPUT_FILE_NAME = "wholeChatsFile.csv"
WHOLE_CHATS_OUTPUT_FILE_NAME_TXT = "wholeChatsFile.txt"
...
##                if cleanWord not in stopWordsDict:
        ...
        ##masterWordList.extend(cleanQuestion.split())
